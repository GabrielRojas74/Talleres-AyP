...
if(cantidad_d >= 5000000):
    ...
    print("El porcentaje que invierte ls empresa en la compra es de: ""{:.0f}".format(
        porcemp))
    print("El porcentaje que invierte el banco por la compra es de: ""{:.0f}".format(
        porcbnc))
    ...
    print("El porcentaje que invierte ls empresa en la compra es de: ""{:.0f}".format(
        porcemp))
    print(
        "El porcentaje que invierte el fabricante sumando los intereses al credito es de: ""{:.0f}".format(ttfab))
